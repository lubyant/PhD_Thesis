...
the most common landforms among them are shorelines and bluffs, which are shown in
...
such as revetments and ripraps. Natural shorelines constitute the predominant
coastal type along Lake Michigan, accounting for more than 80 \% of the total
shoreline length (see Figure \ref{fig:fig1.1}b), with the exception of certain
...
valued at more than 1,000 million dollars, with an estimated cost of \$10,000
per linear foot of lakefront \citep{folger_coastal_1996}. Overall, coastal
geomorphologies, especially coastal bluffs and shorelines, are both prevalent and
...
\begin{figure}[htbp]
  ...
  \caption{The common coastal geomorphologies in Lake Michigan. (a) oblique photos of bluff and shoreline (bluff and shoreline), (b) natural shoreline map and (c) bluff map (tall bluffs over 10 meters) in Lake Michigan.}
  \label{fig:fig1.1}
\end{figure}

Coastal geomorphic change (CGC), also known as coastal accretion and erosion,
is the evolution and transformation of coastal geomorphology over time
...
infrastructure built at the top or base of the bluff, leading to economic
losses and even casualties \citep{deitz_bluff_2024}. For instance, between 2019
and 2022, there were three reported news reports
...
southeastern Wisconsin, over \$2.89 billion dollars were spent to construct,
repair and maintain the structures to protect the local properties and
infrastructure \citep{sanders_2016_nodate}. Despite these considerable
expenditures to mitigate the risks of CGC, there remains an additional critical
step: coastal geomorphology mappings on multiple temporal and spatial scales.
Multi-scale coastal mapping can provide insights into the evolution of coastal
geomorphology across varying temporal and spatial scales, offering valuable
guidance and perspectives for effective prediction and prevention for coastal
hazards \citep{kolednik2014coastal,papakonstantinou2016coastline}. In Lake
Michigan, although numerous projects and studies have been made for the
characterization of coastal geomorphic change, most have been limited to small
regions \citep[\eg][]{swenson_bluff_2006,kilibarda_70year_2015} or short time
periods \citep[\eg][]{lin_field_2014,theuerkauf_coastal_2019}, leaving
multi-spatial and multi-temporal CGC insufficiently explored. Given the lack of
a clear characterization of CGC, it would be valuable to conduct an extensive
mapping and analysis across the coastal region of southwestern Lake Michigan to
address gaps in understanding CGC over multi-spatial and multi-temporal scales.
...
geomorphology: water level and waves. The climatology of water level, which
...
important as it implies the stability of the coastline
...
understand the climatology of hydrodynamic processes, numerous efforts have been
...
monthly lake level fluctuations with validation, as shown in Figure
...
climatology is key to understanding the hydrodynamic properties of wave processes.
...
perpendicular to the contours of the bathymetry as wave propagates through different
...
and wave spectrum. In the Great Lakes, most studies of wave climates have focused on
the annual or monthly trend of wave height
...
exploration to understand the directional spectral wave climate in Lake Michigan
...
environment in the Great Lakes, including wetland habitat
\citep{hohman_influence_2021,anderson_influence_2023}, sandy dunes
\citep{arbogast_maximum-limiting_1999,kilibarda_70year_2015}, bluffs
\citep{volpano_three-dimensional_2020} and beaches \citep{scholle_responses_2022}.
Nevertheless, wave climate characteristics, particularly wave height,
directionality, and the presence of multiple wave systems, are often overlooked,
despite their substantial influence on coastal geomorphological features such as
shorelines and bluffs. For example, wave height determines the wave energy flux,
which is regarded as an important indicator of coastal bluff erosion and
shoreline recession \citep{benumof_relationship_2000,galal_influence_2011}. Wave
height can be further amplified through wave shoaling effects (Figure
\ref{fig:fig1.5}a) and refraction effects (Figure \ref{fig:fig1.5}b), leading to
a steeper lakebed and bluff face, which causes accelerated erosion in the
shoreline and failure in bluffs \citep{booth_wave_1994}. Moreover, the
wave-driven nearshore sediment transport can also lead to the redistribution of
nearshore sediment budgets, which is essential to shoreline erosion
...
height and water level, was also found to control the coastal erosion
...
rotation, which is a common coastal process that occurs at many semi-sheltered and
embayed shorelines
\citep{klein_short-term_2002,wiggins_coastal_2019,wiggins_regionally-coherent_2019,loureiro_24_2020}.
However, despite the fact that wave climate could impact coastal geomorphic
changes, the relationship between coastal geomorphic changes and wind wave
...
\begin{enumerate}
    ...
    \item Relationships: How to indicate CGC with the assistance of directional spectral wave climate?
\end{enumerate}
...
geomorphological changes and wind wave climates. The specific research questions,
objectives, and contributions for each chapter are summarized in the following
table:
